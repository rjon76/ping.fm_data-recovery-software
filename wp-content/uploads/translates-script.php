    ...
    xmlwriter_start_element($xw, 'root');
        ...
        if($onlyFaq == 'false') {
            ...
            do {
                ...
                if( isset($meta->choices) && !empty($meta->choices[0]) && isset($meta->choices[0]->message) && isset($meta->choices[0]->message->content) ) {
                    $translate_meta = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $meta->choices[0]->message->content);
                }
            ...
            do {
                ...
                if( isset($titlepage->choices) && !empty($titlepage->choices[0]) && isset($titlepage->choices[0]->message) && isset($titlepage->choices[0]->message->content) ) {
                    $translate_title = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $titlepage->choices[0]->message->content);
                }
            ...
            do {
                ...
                if( isset($content_first->choices) && !empty($content_first->choices[0]) && isset($content_first->choices[0]->message) && isset($content_first->choices[0]->message->content) ) {
                    $translate_content_first = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $content_first->choices[0]->message->content);
                }
            ...
            do {
                ...
                if( isset($content_second->choices) && !empty($content_second->choices[0]) && isset($content_second->choices[0]->message) && isset($content_second->choices[0]->message->content) ) {
                    $translate_content_second = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $content_second->choices[0]->message->content);
                }
            ...
            do {
                ...
                if( isset($th1title->choices) && !empty($th1title->choices[0]) && isset($th1title->choices[0]->message) && isset($th1title->choices[0]->message->content) ) {
                    $translate_h1title = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $th1title->choices[0]->message->content);
                }
        ...
        do {
            ...
            if( isset($faq_first->choices) && !empty($faq_first->choices[0]) && isset($faq_first->choices[0]->message) && isset($faq_first->choices[0]->message->content) ) {
                $translate_faq_first = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $faq_first->choices[0]->message->content);
            }
        ...
        do {
            ...
            if( isset($faq_second->choices) && !empty($faq_second->choices[0]) && isset($faq_second->choices[0]->message) && isset($faq_second->choices[0]->message->content) ) {
                $translate_faq_second = str_replace(["- $lang", "- 中文", "– Português", "– Nederlands", "– العربية", "– Deutsch", "– Español", "– Svenska"], "", $faq_second->choices[0]->message->content);
            }
