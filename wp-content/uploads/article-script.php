...
function getInfoTitle($title, $anchor_url, $anchor_title, $url_description, $apps_links, $OPENAI_API_KEY) {
    ...
    if($apps_links == 'true') {
        ...
        $stepString1 = 'Step-by-Step Guide with HTML formats. <h3>Method 1: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString2 = 'Step-by-Step Guide with HTML formats. <h3>Method 2: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString3 = 'Step-by-Step Guide with HTML formats. <h3>Method 3: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString4 = 'Step-by-Step Guide with HTML formats. <h3>Method 4: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString5 = 'Step-by-Step Guide with HTML formats. <h3>Method 5: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString6 = 'Step-by-Step Guide with HTML formats. <h3>Method 6: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString7 = 'Step-by-Step Guide with HTML formats. <h3>Method 7: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString8 = 'Step-by-Step Guide with HTML formats. <h3>Method 8: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString9 = 'Step-by-Step Guide with HTML formats. <h3>Method 9: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
        $stepString10 = 'Step-by-Step Guide with HTML formats. <h3>Method 10: [Name of the Method] with 1 emoji</h3> <ul>at one of the steps, important insert link with <a href> to the corresponding website or application in <li> tag inside</ul> tag; <p><b>Note:</b> Note</p>, <p><b>Conclusion:</b> Conclusion or pros & cons</p>';
    }
