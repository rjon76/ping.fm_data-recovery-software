...
xmlwriter_start_element($xw, 'root');
    ...
    writeArticleXML(
        $theme_meta_title, $domain_url . '/wp-content/uploads/ai/'.$image_title.'.jpg',
        $page_url, $page_title, $pageContent, $faqString, $theme_title, $h1title,
        $anchor_url, $url_description, $anchor_title, $image_src, $post_url,
        $pageYoutube, $apps_links, $faq_theme
    );
