...
function getInfoTitle($title, $anchor_url, $anchor_title, $url_description, $apps_links, $OPENAI_API_KEY) {
    ...
    if($apps_links == 'true') {
        ...
        $information_string = "Add valuable information, around 500 words with html formats in <p> tags; inside paragraphs extensively use '<b></b>' for topics, keywords; Only once add <a href='$anchor_url' rel='dofollow' target='_blank'>$anchor_title</a> and add additional relevant links. These should be nofollow links in the format: <a href='[URL]' rel='nofollow' target='_blank'>[URL]</a>";
