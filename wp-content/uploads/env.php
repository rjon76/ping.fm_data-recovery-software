...
function getInfoFaq($title, $number, $OPENAI_API_KEY) {
    ...
    $data = array(
        ...
        'messages' => [
            [
                "role" => "system",
                "content" => "Generate a set of $number related to this keyword questions and $number their corresponding answers (around 30-50 words) for $title.
                            ...
                            MUST be $number related questions and $number their corresponding answers (around 30-50 words).
...
function getTranslate($language, $text, $OPENAI_API_KEY) {
    ...
    $data = array(
        ...
        'messages' => [
            [
                "role" => "system",
                "content" => "It is important not to remove html tags and do not add anything of your own. Translation only. Translate text into $language - $text",
            ],
        ],
    );
