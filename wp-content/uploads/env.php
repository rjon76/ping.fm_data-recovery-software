...
function writeArticleXML( 
    $page_meta, $page_image, $page_url,
    $page_title, $pageContent, $faqString,
    $theme_title, $h1title, $anchor_url,
    $url_description, $anchor_title, $image_src,
    $post_url, $pageYoutube, $apps_links, $faq_theme
) {
