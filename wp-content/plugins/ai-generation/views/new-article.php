...
if( !function_exists("new_post_data") ) {
    function new_post_data(){ ?>
        ...
        <div id="generateArticle" class="tabcontent">
            <form id="article">
                ...
                <input type="text" id="post_url" placeholder="slug without /" name="post_url">
        ...
        <script>
            jQuery("#article").on("submit", function(event) {
                ...
                if( jQuery('#title')[0].value.trim().length === 0 ||
                    ...
                    let errorKey = false;
                    form.append('action', 'chat_gpt_generate_article');
