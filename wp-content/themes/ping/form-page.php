			...
			<div class="container">
                ...
                <?php if(time() > $current) { ?>
                    ...
                    <div id="createdArticles" class="tabcontent">
                        <div>
                            <?php if(count($arrayArticles["page"]) > 1 && !empty($arrayArticles["page"][0])) { ?>
                                <div class="dropdown">
                            ...
                            <?php if(count($arrayArticles["page"]) > 0 && (!empty($arrayArticles["page"][0]) || !empty($arrayArticles["page"]["title"]) )) { ?>
